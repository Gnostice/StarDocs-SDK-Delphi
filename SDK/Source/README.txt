...
3. Open project "<StarDocs Root>\SDK\Source\Packages\gtStarDocsSDK_group.groupproj". 
4. Right-click "gtStarDocsSDK_group" in the Project Manager and choose "Build All".
...
1. Open project "<StarDocs Root>\SDK\Source\Packages\gtUniStarDocsViewer_group.groupproj". 
2. Right-click "gtUniStarDocsViewer_group" in the Project Manager and choose "Build All".
